...
stnu_to_xml(stnu, f"fjsp_gtl_example", "temporal_networks/cstnu_tool/xml_files")
...
if dc:
    ...
    plt.savefig('PyJobShopIntegration/images/fjsp_gtl_example.png')